...
first_box()
{
    ...
    switch (map) {
        case "mp_zombie_lab":
            maps\mp\zombies\_wall_buys::addmagicboxweapon("iw5_exocrossbowzm", "npc_crossbow_base_static_holo", &"ZOMBIES_CROSSBOW", "none", "none", "none", undefined, 1);
        ...
        case "mp_zombie_brg":
            ...
            maps\mp\zombies\_wall_buys::addmagicboxweapon("dna_aoe_grenade_zombie", "npc_exo_launcher_grenade_holo", &"ZOMBIES_DNA_AOE", "none", "none", "none", 2, 2);
            maps\mp\zombies\_wall_buys::addmagicboxweapon("iw5_mahemzm", "npc_mahem_base_holo", &"ZOMBIES_MAHEM", "none", "none", "none", 3);
            break;
        ...
        case "mp_zombie_h2o":
            maps\mp\zombies\_wall_buys::addmagicboxweapon("iw5_dlcgun4zm", "npc_blunderbuss_base_holo", &"ZOMBIE_WEAPONDLC4_GUN", "none", "none", "none", undefined, 2, 1);
            maps\mp\zombies\_wall_buys::addmagicboxweapon("distraction_drone_zombie", "dlc_distraction_drone_01_holo", &"ZOMBIES_DISTRACTION_DRONE", "none", "none", "none", 2, 2);
            maps\mp\zombies\_wall_buys::addmagicboxweapon("iw5_tridentzm", "npc_zom_trident_base_holo", &"ZOMBIE_WEAPON_TRIDENT_PICKUP", "none", "none", "none", undefined, 2, 3); 
            break;
